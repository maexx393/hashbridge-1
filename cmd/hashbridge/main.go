...
/*
Provides the command-line interface for the hashbridge application.

For configuration and CLI commands see the README: https://github.com/hashprotocol/hashbridge.
*/
package main
...
import (
	...
	"github.com/hashprotocol/hashbridge-utils/core"
	"github.com/hashprotocol/hashbridge-utils/metrics/health"
	metrics "github.com/hashprotocol/hashbridge-utils/metrics/types"
	"github.com/hashprotocol/hashbridge-utils/msg"
	"github.com/hashprotocol/hashbridge/chains/ethereum"
	"github.com/hashprotocol/hashbridge/chains/substrate"
	"github.com/hashprotocol/hashbridge/config"
...
var accountCommand = cli.Command{
	...
	Description: "The accounts command is used to manage the bridge keystore.\n" +
		"\tTo generate a new account (key type generated is determined on the flag passed in): hashbridge accounts generate\n" +
		"\tTo import a keystore file: hashbridge accounts import path/to/file\n" +
		"\tTo import a geth keystore file: hashbridge accounts import --ethereum path/to/file\n" +
		"\tTo import a private key file: hashbridge accounts import --privateKey private_key\n" +
		"\tTo list keys: hashbridge accounts list",
...
func init() {
	app.Action = run
	app.Copyright = "Copyright 2022 hashprotocol  Authors"
	app.Name = "hashbridge"
	app.Usage = "HashBridge"
	app.Authors = []*cli.Author{{Name: "hashprotocol  2022"}}
	app.Version = Version
